...
const SIGNED_EXPIRY = 60 * 60 * 24 * 365 * 10; // 10y
...
export function ImageUpload({
  ...
  function handleFocalDrag(e: React.MouseEvent | React.TouchEvent) {
...
export function focalStyle(img: ImageValue | null | undefined): React.CSSProperties {
  if (!img) return {};
