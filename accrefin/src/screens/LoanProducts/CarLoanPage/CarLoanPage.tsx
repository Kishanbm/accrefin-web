...
import { CheckIcon, PlayIcon, StarIcon, UserIcon, ShieldIcon, ClockIcon, FileTextIcon, CreditCardIcon, BanknoteIcon as BanknotesIcon, ChevronDownIcon, ChevronUpIcon, TrendingUpIcon, ZapIcon, GlobeIcon, LockIcon, CarIcon, FuelIcon, CalendarIcon } from "lucide-react";
...
export const CarLoanPage = (): JSX.Element => {
  ...
  // Increment visible partners by 2 until all are shown (matches PersonalLoanPage behavior)
  ...
  // Why Accrefin features for car loans
  const whyAccrefinFeatures = [
    {
      icon: <ZapIcon className="w-6 h-6" />,
      title: "Quick Car Loan Approval",
      subtitle: "Get approved in 30 minutes with minimal documentation",
      iconColor: "text-[#0050B2]",
      bgColor: "bg-blue-50/50"
    },
    {
      icon: <TrendingUpIcon className="w-6 h-6" />,
      title: "Low Interest from 7.5%",
      subtitle: "Competitive rates for new and used cars",
      iconColor: "text-[#0050B2]",
      bgColor: "bg-blue-50/50"
    },
    {
      icon: <CarIcon className="w-6 h-6" />,
      title: "New & Used Car Financing",
      subtitle: "Finance any car from any dealer across India",
      iconColor: "text-[#0050B2]",
      bgColor: "bg-blue-50/50"
    },
    {
  ...
  const carLoanFeatures = [
    {
      ...
      title: "All Car Types",
      description: "Finance hatchbacks, sedans, SUVs, luxury cars, and commercial vehicles",
      bgColor: "bg-blue-50"
    },
    {
      icon: <CalendarIcon className="w-8 h-8" />,
      title: "Flexible Tenure",
      description: "Choose repayment tenure from 1 to 7 years as per your convenience",
      bgColor: "bg-green-50"
    },
    {
      icon: <ShieldIcon className="w-8 h-8" />,
      title: "Insurance Included",
      description: "Comprehensive car insurance options available with your loan",
      bgColor: "bg-purple-50"
    },
    {
      icon: <CheckIcon className="w-8 h-8" />,
      title: "No Hidden Charges",
      description: "Transparent pricing with all fees disclosed upfront",
      bgColor: "bg-orange-50"
    }
  ];

  // Bank offers data for car loans
  const bankOffers = [
        { bank: "HDFC Bank", logo: "/logos/h.png", interestRate: "7.50% - 13.75%", processingFee: "Up to 2.50%", loanAmount: "₹1L - ₹1Cr", features: ["Quick Approval", "Doorstep Service"], rating: 4.3, highlight: "Most Popular" },
        { bank: "ICICI Bank", logo: "/logos/i.png", interestRate: "8.00% - 14.00%", processingFee: "Up to 2.00%", loanAmount: "₹1L - ₹75L", features: ["Digital Process", "Quick Disbursal"], rating: 4.2, highlight: "Best Rate" },
        { bank: "Axis Bank", logo: "/logos/A.png", interestRate: "8.25% - 15.00%", processingFee: "Up to 3.00%", loanAmount: "₹1L - ₹50L", features: ["Flexible EMI", "Easy Documentation"], rating: 4.1, highlight: "Flexible Terms" },
        { bank: "Kotak Bank", logo: "/logos/k.png", interestRate: "8.50% - 14.00%", processingFee: "Up to 2.50%", loanAmount: "₹1L - ₹40L", features: ["Digital Approval"], rating: 4.0, highlight: "Fast" },
        { bank: "PNB", logo: "/logos/p.png", interestRate: "7.80% - 13.00%", processingFee: "Up to 1.50%", loanAmount: "₹1L - ₹60L", features: ["Low Fee"], rating: 4.5, highlight: "Low Fee" },
    ];

  // Eligibility criteria for car loans
  const eligibilityCriteria = [
    { criteria: "Age", requirement: "21-65 years", icon: "👤" },
    { criteria: "Monthly Income", requirement: "Minimum ₹20,000 for salaried", icon: "💰" },
    ...
    { criteria: "Down Payment", requirement: "10-20% of car value", icon: "🏦" }
  ];
  ...
  const requiredDocs = [
    ...
    {
      category: "Car Related Documents",
      icon: "🚗",
      docs: [
  ...
  // Processing fees for car loans
  const processingFees = [
    { particular: "Processing Fees", charges: "0.5% to 3% of loan amount + GST" },
    { particular: "Documentation Charges", charges: "₹1,000 to ₹5,000 + GST" },
    { particular: "Prepayment Charges", charges: "2% to 4% of outstanding amount (after 12 months)" },
    ...
    { particular: "Swap Charges", charges: "₹500 to ₹1,000 per swap" }
  ];

  // Car loan FAQs
  const faqs = [
    {
      question: "What is the maximum loan amount I can get for a car loan?",
      answer: "Car loan amounts typically range from ₹1 lakh to ₹1 crore, depending on your income, credit score, and the car's value. Most lenders finance up to 85-90% of the car's on-road price."
    },
    {
      question: "Can I get a loan for a used car?",
      answer: "Yes, most banks and NBFCs offer loans for used cars. However, the car should typically be less than 5-7 years old, and the loan amount may be lower compared to new cars."
    },
    {
      question: "What is the minimum down payment required?",
      answer: "The minimum down payment is usually 10-20% of the car's on-road price. A higher down payment can help you get better interest rates and reduce your EMI burden."
    },
    {
      question: "How long does it take to get car loan approval?",
      answer: "With complete documentation, car loan approval can take anywhere from 30 minutes to 3 working days. Digital lenders often provide faster approvals."
    },
    {
      question: "Can I prepay my car loan?",
      answer: "Yes, most lenders allow prepayment after 12 months. However, prepayment charges of 2-4% of the outstanding amount may apply. Some lenders offer zero prepayment charges."
    },
    {
      question: "What happens if I default on my car loan EMI?",
      answer: "Defaulting on EMIs can result in penalty charges, negative impact on credit score, and potential repossession of the vehicle. It's important to contact your lender if you're facing payment difficulties."
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start pb-14">
            ...
            <div className="space-y-6">
              <h1 className={`text-4xl lg:text-5xl xl:text-[56px] font-normal text-gray-900 leading-[1.15] tracking-tight ${headingFont}`}>
                Check Car<br />Loan Offers Online
              </h1>
              <p className={`text-base lg:text-lg text-gray-600 leading-relaxed max-w-lg ${bodyFont} font-medium`}>
                Get a car loan of up to Rs 50 lakh at an interest rate starting from 7.5% p.a. for the
                tenures of up to 5 years. Quick approval with minimal documentation from 40+ partner lenders.
              </p>
            </div>
                  ...
                  {formStatus === 'FORM' && (
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div>
                        ...
                        >
                          <option value="default" disabled hidden>Car Type</option>
        ...
        <div className="container mx-auto max-w-7xl px-4">
          <div className="text-center mb-12">
            <h2 className={`text-3xl lg:text-5xl text-[#273240] mb-4 tracking-tight font-normal ${headingFont}`}>
              Why Choose Accrefin for Your Car Loan?
            </h2>
            <p className={`text-lg text-gray-500 font-medium ${bodyFont}`}>
              Experience the future of car financing with our advanced technology
            </p>
          </div>
      ...
      <section id="features" className="py-16 bg-white">
        <div className="container mx-auto max-w-7xl px-4">
          <div className="text-center mb-12">
            ...
            <p className={`text-lg text-gray-500 font-medium ${bodyFont}`}>
              Comprehensive features designed for your convenience
            </p>
          </div>
      ...
      <section id="documents" className="py-20 bg-white relative overflow-hidden">
        <div className="container mx-auto max-w-7xl px-4 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className={`text-lg text-gray-500 font-medium ${bodyFont}`}>
              Applicants usually require the following documents for processing car loan applications.
            </p>
          </div>
            ...
            <CardContent className="p-10 lg:p-12">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
                ...
                <div>
                  ...
                  <input type="range" min="7.5" max="18" step="0.1" value={interestRate}
                    onChange={(e) => setInterestRate(Number(e.target.value))}
                    className="w-full h-2 bg-gray-200 rounded-lg cursor-pointer slider mt-3"
                    style={{ '--fill-percent': getFillPercentage(interestRate, 7.5, 18) } as React.CSSProperties}
                  />
                  <div className={`flex justify-between text-xs text-gray-400 mt-1 ${bodyFont}`}>
                    <span>7.5%</span><span>18%</span>
                  </div>
                </div>
              </div>
      ...
      <section id="fees" className="py-20 bg-[#0E1A3A] relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl px-4 relative z-10">
          <div className="mb-20">
            <div className="text-center mb-16">
              <h2 className={`text-3xl lg:text-5xl text-white mb-4 tracking-tight font-normal ${headingFont}`}>
                Car Loan Processing Fees and Charges
              </h2>
              <p className={`text-lg text-white/70 font-medium ${bodyFont}`}>
