...
import { StarIcon, UserIcon, FileTextIcon, ChevronDownIcon, ChevronUpIcon, TrendingUpIcon, ZapIcon, LockIcon, BuildingIcon, BarChart3Icon, UsersIcon, FactoryIcon, SettingsIcon, PenToolIcon as ToolIcon, TruckIcon } from "lucide-react";
...
export const MachineryLoanPage = (): JSX.Element => {
...
const highlightFormFields = () => {
  ...
  // Why Accrefin features for machinery loans
  const whyAccrefinFeatures = [
    {
      icon: <ZapIcon className="w-6 h-6" />,
      title: "Quick Machinery Approval",
      subtitle: "Get approved in 24 hours with minimal documentation",
      iconColor: "text-[#0050B2]",
      bgColor: "bg-blue-50/50"
    },
    {
      icon: <TrendingUpIcon className="w-6 h-6" />,
      title: "Competitive Rates from 10%",
      subtitle: "Best-in-class interest rates for machinery financing",
      iconColor: "text-[#0050B2]",
      bgColor: "bg-blue-50/50"
    },
    {
      ...
      subtitle: "Access to 50+ banks and NBFCs for best offers",
      iconColor: "text-[#0050B2]",
      bgColor: "bg-blue-50/50"
    },
    {
      ...
      subtitle: "Customized repayment options for your business cycle",
      iconColor: "text-[#0050B2]",
      bgColor: "bg-blue-50/50"
    }
  ];

  // Machinery loan use cases
  const machineryUseCases = [
    { emoji: "🏭", title: "Manufacturing", description: "Upgrade production machinery and equipment" },
    { emoji: "🚜", title: "Agriculture", description: "Tractors, harvesters, and farming equipment" },
    { emoji: "🏗️", title: "Construction", description: "Excavators, loaders, and construction machinery" },
    { emoji: "🔧", title: "Engineering", description: "CNC machines, lathes, and precision tools" },
    { emoji: "🧵", title: "Textile", description: "Sewing, weaving, and textile processing machines" },
    { emoji: "🔬", title: "Medical", description: "Medical and laboratory equipment" }
  ];

  // Bank offers data for machinery loans
  const bankOffers = [
        { bank: "HDFC Bank", logo: "/logos/h.png", interestRate: "10.00% - 18.00%", processingFee: "Up to 2.00%", loanAmount: "₹5L - ₹1Cr", features: ["Quick Approval", "Flexible Tenure"], rating: 4.3, highlight: "Most Popular" },
        { bank: "ICICI Bank", logo: "/logos/i.png", interestRate: "10.25% - 16.00%", processingFee: "Up to 2.50%", loanAmount: "₹5L - ₹75L", features: ["Digital Process", "Quick Disbursal"], rating: 4.2, highlight: "Best Rate" },
        { bank: "Axis Bank", logo: "/logos/A.png", interestRate: "11.00% - 20.00%", processingFee: "Up to 3.00%", loanAmount: "₹5L - ₹2Cr", features: ["Collateral Free", "Easy Documentation"], rating: 4.1, highlight: "High Amount" },
        { bank: "SBI", logo: "/logos/s.png", interestRate: "9.50% - 15.00%", processingFee: "Up to 1.50%", loanAmount: "₹5L - ₹1.5Cr", features: ["Lowest Rates"], rating: 4.5, highlight: "Low Rate" },
        { bank: "PNB", logo: "/logos/p.png", interestRate: "10.80% - 17.00%", processingFee: "Up to 2.00%", loanAmount: "₹5L - ₹1Cr", features: ["Fast Approval"], rating: 4.0, highlight: "Fast" },
    ];

  // Interest rate factors for machinery loans
  ...
  const eligibilityCriteria = [
    ...
    { criteria: "Annual Turnover", requirement: "Minimum ₹15 lakhs per annum", icon: "📊" },
  ...
  // Required documents for machinery loans
  const requiredDocs = [
    {
    ...
    {
      category: "Machinery Details",
      icon: "🔧",
      docs: [
        "Machinery Quotation/Proforma Invoice",
        "Technical Specifications",
        "Machinery Valuation Report (for used machinery)",
        "Vendor Details",
        "Installation Plan",
        "Machinery Insurance Details"
      ]
    },
    {
  ...
  // Processing fees for machinery loans
  const processingFees = [
    ...
    { particular: "Technical Evaluation Charges", charges: "₹5,000 to ₹25,000 + GST" },
  ...
  const faqs = [
    {
      question: "What is the minimum business vintage required for a machinery loan?",
      answer: "Most lenders require a minimum business vintage of 2-3 years. However, some NBFCs may consider businesses with 1 year of operations for smaller loan amounts, especially if the machinery serves as collateral."
    },
    {
      question: "Can I get a machinery loan without collateral?",
      answer: "Yes, unsecured machinery loans are available up to ₹50 lakhs without any collateral. For higher amounts, lenders may require collateral or personal guarantee. The machinery itself often serves as primary collateral."
    },
    {
      question: "What documents are required for machinery loan approval?",
      answer: "Key documents include business registration certificates, ITR for last 2 years, bank statements, GST returns, financial statements, machinery quotation/invoice, and identity/address proof of promoters."
    },
    {
      question: "How is the interest rate determined for machinery loans?",
      answer: "Interest rates depend on factors like business vintage, turnover, credit score, industry type, machinery type and value, loan amount, and your relationship with the lender."
    },
    {
      question: "Can I prepay my machinery loan?",
      answer: "Yes, most lenders allow prepayment of machinery loans. However, prepayment charges of 2-4% of the outstanding amount may apply depending on the lender's terms."
    },
    {
      question: "What is the maximum loan amount I can get?",
      answer: "Machinery loan amounts typically range from ₹5 lakhs to ₹2 crores, depending on your business turnover, credit profile, machinery value, and lender policies."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto max-w-7xl px-6 pt-8 pb-0 relative z-10">
          ...
          <div className="mb-6">
            <nav className={`flex items-center space-x-2 text-sm ${bodyFont}`}>
              ...
              <span className="text-gray-600">Machinery Loan</span>
            </nav>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start pb-14">
            ...
            <div className="space-y-6">
              <h1 className={`text-4xl lg:text-5xl xl:text-[56px] font-normal text-gray-900 leading-[1.15] tracking-tight ${headingFont}`}>
                Check Machinery<br />Loan Offers Online
              </h1>
              <p className={`text-base lg:text-lg text-gray-600 leading-relaxed max-w-lg ${bodyFont} font-medium`}>
                Get a machinery loan of up to Rs 2 crore at an interest rate starting from 9% p.a. for the tenures of up to 5 years. Quick approval with minimal documentation from 30+ partner lenders.
              </p>
            </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div>
                        <select
                          ...
                          defaultValue="default"
                        >
                          <option value="default" disabled hidden>Machinery Type</option>
      ...
      {/* Enhanced Bank Offers Section - Horizontal Scrollable Cards */}
      <section id="overview" className="py-16 bg-white">
        <div className="container mx-auto max-w-7xl px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Best Machinery Loan Offers
            </h2>
            <p className="text-xl text-gray-600">
              Compare and choose from top machinery lenders
            </p>
          </div>
              ...
              <Card key={index} className="min-w-[294px] w-[294px] bg-[#f5f9ff] border-[#e1e1e1] flex-shrink-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-6 flex flex-col items-center gap-4">
                  ...
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <div className="font-bold text-gray-900 text-center">{offer.bank}</div>
                  ...
                  <div className="w-full space-y-3 text-center">
                    <div>
                      ...
                      <div className="font-bold text-gray-900">{offer.interestRate}</div>
                    </div>
                    <div>
                      <div className="text-sm text-gray-500 mb-1">Processing Fee</div>
                      <div className="font-bold text-gray-900">{offer.processingFee}</div>
                    </div>
                    <div>
                      <div className="text-sm text-gray-500 mb-1">Loan Amount</div>
                      <div className="font-bold text-gray-900">{offer.loanAmount}</div>
                    </div>
                  </div>
            ...
            {[
              {
                ...
                title: "All Machinery Types",
                description: "Finance manufacturing, construction, agricultural, and medical equipment"
              },
              {
                icon: <SettingsIcon className="w-8 h-8" />,
                title: "New & Used Machinery",
                description: "Options for both new and pre-owned machinery with flexible terms"
              },
              {
                icon: <ToolIcon className="w-8 h-8" />,
                title: "Up to 100% Financing",
                description: "Get up to 100% funding for new machinery purchases"
              },
              {
                icon: <TruckIcon className="w-8 h-8" />,
                title: "Tax Benefits",
                description: "Claim depreciation benefits and tax advantages on machinery loans"
              }
            ].map((feature, index) => (
              <div
                key={index}
      ...
      {/* Machinery Loan Use Cases - New dedicated section */}
      <section className="py-16 bg-white">
        <div className="container mx-auto max-w-7xl px-4">
          <div className="text-center mb-12">
            <h2 className={`text-3xl lg:text-5xl text-[#273240] mb-4 tracking-tight font-normal ${headingFont}`}>
              How You Can Use Your Machinery Loan
            </h2>
            <p className={`text-lg text-gray-500 font-medium ${bodyFont}`}>
              Flexible funding for all your machinery needs
            </p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {machineryUseCases.map((useCase, index) => (
              <Card 
                key={index}
              ...
              >
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="font-bold text-gray-900 mb-2 group-hover:text-[#0050B2] transition-colors duration-300">
                    {useCase.title}
                  </h3>
      ...
      {/* Enhanced EMI Calculator - Dark Theme */}
        ...
        <div className="container mx-auto max-w-7xl px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className={`text-lg text-white/70 font-medium ${bodyFont}`}>
              Calculate your monthly EMI and plan your machinery finances
            </p>
          </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
                <div>
                  ...
                  <input type="range" min="100000" max="20000000" step="100000" value={loanAmount}
                    ...
                    style={{ '--fill-percent': getFillPercentage(loanAmount, 100000, 20000000) } as React.CSSProperties}
                  />
                ...
                <div>
                  ...
                  <input type="range" min="12" max="84" value={tenure}
                ...
                <div>
                  ...
                  <input type="range" min="10" max="22" step="0.1" value={interestRate}
                    onChange={(e) => setInterestRate(Number(e.target.value))}
                    className="w-full h-2 bg-gray-200 rounded-lg cursor-pointer slider mt-3"
                    style={{ '--fill-percent': getFillPercentage(interestRate, 10, 22) } as React.CSSProperties}
                  />
                  <div className={`flex justify-between text-xs text-gray-400 mt-1 ${bodyFont}`}>
      ...
      <section id="documents" className="py-20 bg-white relative overflow-hidden">
        <div className="container mx-auto max-w-7xl px-4 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className={`text-lg text-gray-500 font-medium ${bodyFont}`}>
              Applicants usually require the following documents for processing machinery loan applications.
            </p>
          </div>
      ...
      <section id="fees" className="py-20 bg-[#0E1A3A] relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl px-4 relative z-10">
          <div className="mb-20">
            <div className="text-center mb-16">
              <h2 className={`text-3xl lg:text-5xl text-white mb-4 tracking-tight font-normal ${headingFont}`}>
                Machinery Loan Processing Fees and Charges
              </h2>
              <p className={`text-lg text-white/70 font-medium ${bodyFont}`}>
